...
public class MultiplayerAnalog : MonoBehaviour {

	//Singleton Structure
	protected static MultiplayerAnalog mInstance;
	public static MultiplayerAnalog Instance
	{
		get
		{
			if (mInstance == null)
			{
				mInstance = new MultiplayerAnalog();
			}
			return mInstance;
		}
	}
