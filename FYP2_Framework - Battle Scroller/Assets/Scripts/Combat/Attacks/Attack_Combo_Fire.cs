...
public class Attack_Combo_Fire : AttackScript 
{
    ...
    IEnumerator ComboFire()
    {
        while (this.gameObject.activeSelf)
        {
            ...
            {
                BulletScript TempBullet = Instantiate(BulletPrefab, PlayerInstance.Instance.transform.position,
                                                      Quaternion.identity) as BulletScript;
                float Negate = 1;
